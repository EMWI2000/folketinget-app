...
export default function StyrelsesbenchmarkContent() {
                      ...
                      return (
                        <div key={agency.agency.code}>
                          <div className="flex justify-between text-sm mb-1">
                            ...
                            <span className="text-gray-600 dark:text-gray-400 font-mono ml-2">{formatBudget(value)} mio.</span>
                          </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-3 sm:p-4">
                  <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
                    ...
                    <span className="ml-2 text-xs font-normal text-gray-500 dark:text-gray-400">
                      (FL {selectedYear}, {VALUE_KEY_LABELS[valueKey]})
                    </span>
                  </h3>
                    ...
                    <table className="w-full text-sm min-w-[500px]">
                      <thead>
                        <tr className="border-b border-gray-200 dark:border-gray-700">
                          <th className="text-left py-2 pr-4 pl-3 sm:pl-0 text-gray-600 dark:text-gray-400 font-medium">Standardkonto</th>
                          {selectedAgencies.map(({ agency, color }) => (
...
/** Simpel tidsserie-graf */
function TimeSeriesChart({
  data,
}: {
  data: { agency: string; color: string; points: { year: number; value: number; source: string }[] }[]
}) {
