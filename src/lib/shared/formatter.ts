/**
 * Delte talformaterings-hjælpere brugt på tværs af finanslov- og regnskabs-modulerne.
 * Domæne-modulerne re-eksporterer disse under domænespecifikke navne.
 */
